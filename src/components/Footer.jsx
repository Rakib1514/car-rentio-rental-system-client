    ...
    <div>
      <footer className="footer bg-base-200 p-10 mt-12">
        <aside>
          ...
          />
          <p>
            <span className="font-bold text-2xl">Car-Rentio</span>
            <br />
      ...
      <aside className=" text-center bg-base-200 pb-4">
        <p>
          Copyright © {new Date().getFullYear()} - All right reserved by Car-Rentio
        </p>
      </aside>
    </div>
  );
