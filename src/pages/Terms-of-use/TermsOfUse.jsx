...
const TermsOfUse = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 text-gray-700">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold font-openSans mb-2">2. Eligibility</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold font-openSans mb-2">3. Vehicle Rental Terms</h2>
        <ul className="list-disc pl-5">
          ...
          <li>Vehicles must be returned on time to avoid additional charges.</li>
        </ul>
      </section>

      <section className="mb-6">
        <h2 className="text-xl font-semibold font-openSans mb-2">4. Payments & Cancellations</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold font-openSans mb-2">5. Prohibited Uses</h2>
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold font-openSans mb-2">6. Liability & Insurance</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold font-openSans mb-2">7. Termination & Account Suspension</h2>
        <p>
      ...
      <section>
        <h2 className="text-xl font-semibold font-openSans mb-2">8. Changes to Terms</h2>
        <p>
